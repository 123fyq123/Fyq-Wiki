...
### 变换选区
+   首先使用“矩形选框工具”绘制一个长方形选区。对创建好的选区执行**“选择>变换选区”**命令或按Alt+S+T组合键，可以对选区进行移动。
+   在选区变换状态下，在画布中右击，还可以选择其他变换方式。
![](../img/28.png)

### 全选与反选
+   全选：全选图像常用于复制整个文档中的图像。执行“ 选 择 > 全 部 ” 命 令 或 按Ctrl+A 组合键，可以选择当前文档边界内的所有图像示。
+   反选：创建选区以后，执行“选择 > 反向选择”命令或按Shift+Ctrl+I 组合键，可以选择反相的选区，也就是选择图像中没有被选择的部分。
